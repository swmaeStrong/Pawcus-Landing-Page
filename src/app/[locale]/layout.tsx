...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  const ogImageUrl = `${baseUrl}${localePath}/opengraph-image`;

  const title = isKorean
    ? "Co-molib - 당신의 집중력을 극대화하세요"
    : "Co-molib - Maximize Your Focus";
  ...
  return {
    ...
    other: {
      ...
      "al:web:url": `${baseUrl}${localePath}`,
      "al:web:should_fallback": "true",
      "og:image:secure_url": ogImageUrl,
      "og:image:width": "1200",
      "og:image:height": "630",
      "og:image:alt": title,
      "og:locale": isKorean ? "ko_KR" : "en_US",
      "og:locale:alternate": isKorean ? "en_US" : "ko_KR",
    },
  };
}
