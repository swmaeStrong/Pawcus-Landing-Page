        ...
        <div className="space-y-8">
          ...
          <Card className="bg-white/80 backdrop-blur-sm shadow-xl border-gray-200">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-3">
                <div className="bg-gray-100/50 rounded-lg p-4 border border-gray-300/50">
                  <h4 className="font-semibold text-gray-700 mb-2">가. 회원가입 및 관리</h4>
                  <div className="ml-4 space-y-2">
                    <p className="text-sm text-gray-600">
                      <span className="font-medium text-gray-700">필수항목:</span> 이메일 주소, 사용자의 서비스 이용 기록, 접속 로그, 접속 IP 정보, 쿠키, 서비스 이용 시간
                    </p>
                    <p className="text-sm text-gray-600">
                      <span className="font-medium text-gray-700">선택항목:</span> 결제 정보(카드번호, 계좌정보 등 - 암호화하여 관리), 프로필 정보
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-gray-100/50 rounded-lg p-4 border border-gray-300/50">
                  <h4 className="font-semibold text-gray-700 mb-2">다. 인터넷 서비스 이용과정에서 자동 생성되어 수집되는 정보</h4>
                  <p className="text-sm text-gray-600 ml-4">
                ...
                <div className="bg-gray-100/50 rounded-lg p-4 border border-gray-300/50">
                  ...
                  <div className="mt-3 space-y-2">
                    <div className="bg-gray-200/50 rounded p-3">
                      <p className="text-sm text-gray-700 font-medium">전자상거래 등에서의 소비자 보호에 관한 법률</p>
                    ...
                    <div className="bg-gray-200/50 rounded p-3">
                      <p className="text-sm text-gray-700 font-medium">통신비밀보호법</p>
                      <ul className="list-disc list-inside text-sm text-gray-500 ml-4 mt-1">
          ...
          <Card className="bg-white/80 backdrop-blur-sm shadow-xl border-gray-200">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-3">
                ...
                <div className="bg-gray-100/50 rounded-lg p-4 border border-gray-300/50">
                  <h4 className="font-semibold text-gray-700 mb-2">다. 파기방법</h4>
                  <div className="space-y-2">
                    <p className="text-sm text-gray-600">
                      <span className="font-medium text-gray-700">• 전자적 파일 형태의 정보:</span> 기록을 재생할 수 없는 기술적 방법을 사용하여 완전히 삭제
                    </p>
                    <p className="text-sm text-gray-600">
                      <span className="font-medium text-gray-700">• 종이에 출력된 개인정보:</span> 분쇄기로 분쇄하거나 소각을 통하여 파기
                    </p>
                  </div>
                </div>
              </div>
          ...
          <Card className="bg-white/80 backdrop-blur-sm shadow-xl border-gray-200">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-3">
                <div className="bg-gray-100/50 rounded-lg p-4 border border-gray-300/50">
                  <h4 className="font-semibold text-gray-700 mb-2">가. 정보주체의 권리</h4>
                ...
                <div className="bg-gray-100/50 rounded-lg p-4 border border-gray-300/50">
                  <h4 className="font-semibold text-gray-700 mb-2">나. 권리 행사 방법</h4>
          ...
          <Card className="bg-white/80 backdrop-blur-sm shadow-xl border-gray-200">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="bg-gray-100/50 rounded-lg p-4 border border-gray-300/50">
                <h4 className="font-semibold text-gray-700 mb-2">개정 전 고지 의무</h4>
                <p className="text-sm text-gray-600">
          ...
          <Card className="bg-white/80 backdrop-blur-sm shadow-xl border-gray-200">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex justify-center">
                <div className="bg-gray-100/50 rounded-lg p-4 border border-gray-300/50 w-full max-w-md">
                  ...
                  <div className="space-y-2 text-sm">
                    <p className="text-gray-600">
                      <span className="font-medium text-gray-700">성명:</span> 김영현
                    </p>
                    <p className="text-gray-600">
                      <span className="font-medium text-gray-700">직책:</span> 대표
                    </p>
                    <p className="text-gray-600">
                      <span className="font-medium text-gray-700">연락처:</span> 010-5172-5645
                    </p>
                    <p className="text-gray-600">
                      <span className="font-medium text-gray-700">이메일:</span> swmaestrong@gmail.com
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-6">
                <h4 className="font-semibold text-gray-700 mb-3">기타 개인정보침해 신고 및 상담기관</h4>
