        ...
        <div className="space-y-8">
          ...
          <Card className="bg-gray-800/80 backdrop-blur-sm shadow-xl border-gray-700">
            ...
            <CardContent className="prose prose-gray max-w-none">
              <p className="text-gray-300 leading-relaxed">
                이 약관은 집중(이하 "회사"라 합니다)이 제공하는 집중 서비스(이하 "서비스"라 합니다)의 이용과 관련하여 
          ...
          <Card className="bg-gray-800/80 backdrop-blur-sm shadow-xl border-gray-700">
            ...
            <CardContent className="space-y-3">
              ...
              <div className="space-y-3 ml-4">
                <div>
                  <span className="font-medium text-gray-200">1. "서비스"</span>
                ...
                <div>
                  <span className="font-medium text-gray-200">2. "이용자"</span>
                  <p className="text-sm text-gray-300 ml-4">
                ...
                <div>
                  <span className="font-medium text-gray-200">3. "회원"</span>
                  <p className="text-sm text-gray-300 ml-4">
                ...
                <div>
                  <span className="font-medium text-gray-200">4. "아이디(ID)"</span>
                  <p className="text-sm text-gray-300 ml-4">
                ...
                <div>
                  <span className="font-medium text-gray-200">5. "비밀번호"</span>
                  <p className="text-sm text-gray-300 ml-4">
          ...
          <Card className="bg-gray-800/80 backdrop-blur-sm shadow-xl border-gray-700">
            ...
            <CardContent className="space-y-4">
              <div>
                <h4 className="font-semibold text-gray-100 mb-2">① 이용계약의 성립</h4>
              ...
              <div>
                <h4 className="font-semibold text-gray-100 mb-2">② 가입신청</h4>
                <p className="text-gray-300 ml-4">
              ...
              <div>
                <h4 className="font-semibold text-gray-100 mb-2">③ 가입신청의 승낙</h4>
                <p className="text-gray-300 ml-4">
                  회사는 다음 각 호에 해당하지 않는 한 가입신청을 승낙합니다.
                </p>
                <ul className="list-disc list-inside text-sm text-gray-300 mt-2 ml-8 space-y-1">
          ...
          <Card className="bg-gray-800/80 backdrop-blur-sm shadow-xl border-gray-700">
            ...
            <CardContent className="space-y-4">
              <div>
                <h4 className="font-semibold text-gray-100 mb-2">① 서비스의 제공</h4>
                <p className="text-gray-300">회사는 다음과 같은 서비스를 제공합니다:</p>
                <ul className="list-disc list-inside text-sm text-gray-300 mt-2 ml-4 space-y-1">
                  <li>시간 추적 및 생산성 분석 서비스</li>
                  <li>집중도 측정 및 분석 서비스</li>
                  <li>개인 생산성 리포트</li>
              ...
              <div>
                <h4 className="font-semibold text-gray-100 mb-2">② 서비스의 변경</h4>
                <p className="text-gray-300">
              ...
              <div>
                <h4 className="font-semibold text-gray-100 mb-2">③ 서비스 이용시간</h4>
                <p className="text-gray-300">
          ...
          <Card className="bg-gray-800/80 backdrop-blur-sm shadow-xl border-gray-700">
            ...
            <CardContent className="space-y-3">
              ...
              <div className="bg-gray-700/30 rounded-lg p-4 border border-gray-600/30">
                <h4 className="font-semibold text-gray-100 mb-2">다음의 경우 이용이 제한될 수 있습니다:</h4>
          ...
          <Card className="bg-gray-800/80 backdrop-blur-sm shadow-xl border-gray-700">
            ...
            <CardContent className="space-y-3">
              <p className="text-gray-300 font-medium">이용자는 다음 행위를 하여서는 안 됩니다:</p>
          ...
          <Card className="bg-gray-800/80 backdrop-blur-sm shadow-xl border-gray-700">
            ...
            <CardContent className="space-y-3">
              <div>
                <h4 className="font-semibold text-gray-100 mb-2">① 회원의 해지</h4>
                <p className="text-gray-300 ml-4">
              ...
              <div>
                <h4 className="font-semibold text-gray-100 mb-2">② 회사의 해지</h4>
                <p className="text-gray-300 ml-4">
          ...
          <Card className="bg-gray-800/80 backdrop-blur-sm shadow-xl border-gray-700">
            ...
            <CardContent className="space-y-3">
              ...
              <div className="bg-gray-700/30 rounded-lg p-4 space-y-2 border border-gray-600/30">
                <p className="text-sm text-gray-300">• 상호: 집중</p>
                <p className="text-sm text-gray-300">• 대표자: 김영현</p>
                <p className="text-sm text-gray-300">• 주소: 전라남도 나주시 우정로 77</p>
                <p className="text-sm text-gray-300">• 전화: 010-5172-5645</p>
                <p className="text-sm text-gray-300">• 이메일: swmaestrong@gmail.com</p>
              </div>
            </CardContent>
          </Card>
