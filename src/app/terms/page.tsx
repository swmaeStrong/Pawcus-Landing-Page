        ...
        <div className="space-y-8">
          ...
          <Card className="bg-white/80 backdrop-blur-sm shadow-xl border-gray-200">
            ...
            <CardContent className="space-y-4">
              <div>
                <h4 className="font-semibold text-gray-700 mb-2">① 이용계약의 성립</h4>
              ...
              <div>
                <h4 className="font-semibold text-gray-700 mb-2">② 가입신청</h4>
                <p className="text-gray-600 ml-4">
              ...
              <div>
                <h4 className="font-semibold text-gray-700 mb-2">③ 가입신청의 승낙</h4>
                <p className="text-gray-600 ml-4">
          ...
          <Card className="bg-white/80 backdrop-blur-sm shadow-xl border-gray-200">
            ...
            <CardContent className="space-y-4">
              <div>
                <h4 className="font-semibold text-gray-700 mb-2">① 서비스의 제공</h4>
              ...
              <div>
                <h4 className="font-semibold text-gray-700 mb-2">② 서비스의 변경</h4>
                <p className="text-gray-600">
              ...
              <div>
                <h4 className="font-semibold text-gray-700 mb-2">③ 서비스 이용시간</h4>
                <p className="text-gray-600">
          ...
          <Card className="bg-white/80 backdrop-blur-sm shadow-xl border-gray-200">
            ...
            <CardContent className="space-y-3">
              ...
              <div className="bg-gray-100/50 rounded-lg p-4 border border-gray-300/50">
                <h4 className="font-semibold text-gray-700 mb-2">다음의 경우 이용이 제한될 수 있습니다:</h4>
          ...
          <Card className="bg-white/80 backdrop-blur-sm shadow-xl border-gray-200">
            ...
            <CardContent className="space-y-3">
              <div>
                <h4 className="font-semibold text-gray-700 mb-2">① 회원의 해지</h4>
                <p className="text-gray-600 ml-4">
              ...
              <div>
                <h4 className="font-semibold text-gray-700 mb-2">② 회사의 해지</h4>
                <p className="text-gray-600 ml-4">
