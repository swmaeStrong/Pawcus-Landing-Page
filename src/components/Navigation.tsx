      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-md border-b border-gray-200/50 shadow-sm" role="navigation" aria-label="Main Navigation">
        ...
        <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center space-x-2 ml-4 pl-4 border-l border-gray-200">
              ...
              <div className="group relative">
                ...
                <Button
                  ...
                  className="relative bg-white hover:bg-gray-50 text-gray-800 border border-purple-500 hover:border-purple-600 backdrop-blur-sm px-3 py-1.5 rounded-lg transition-all duration-300 hover:scale-105 font-medium text-sm shadow-lg hover:shadow-purple-500/20"
                  size="sm"
                >
              ...
              <div className="group relative">
                ...
                <Button
                  ...
                  className="relative bg-white hover:bg-gray-50 text-gray-800 border border-emerald-500 hover:border-emerald-600 backdrop-blur-sm px-3 py-1.5 rounded-lg transition-all duration-300 hover:scale-105 font-medium text-sm shadow-lg hover:shadow-emerald-500/20"
                  size="sm"
                >
                  <div className="flex items-center space-x-2">
          ...
          <div className="flex md:hidden items-center space-x-2">
            ...
            <Button
              onClick={() => copyToClipboard('brew tap swmaeStrong/pawcus && brew install --cask pawcus')}
              className="relative bg-white text-gray-800 border border-purple-500 px-2 py-1 rounded-lg text-xs font-medium"
              size="sm"
            >
            ...
            <Button
              ...
              className="relative bg-white text-gray-800 border border-emerald-500 px-2 py-1 rounded-lg text-xs font-medium"
              size="sm"
            >
