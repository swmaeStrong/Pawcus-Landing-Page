      ...
      <article className="mb-24 scroll-animate">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-24">
          <div className="order-2 lg:order-1">
            <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-6 text-gray-800">카테고리별 시간 분석</h3>
          ...
          <div className="order-1 lg:order-2">
            <figure>
              <div className="aspect-square bg-[#1C1C1C] flex items-center justify-center p-2 sm:p-3 md:p-4 rounded-xl shadow-2xl border border-gray-200 hover:shadow-purple-500/20 transition-all duration-500 hover:scale-105 relative overflow-hidden group">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-24">
          <div className="order-1">
            <figure>
              <div className="rounded-xl shadow-2xl border border-gray-200 hover:shadow-emerald-500/20 transition-all duration-500 hover:scale-105 relative overflow-hidden group">
          ...
          <div className="order-2">
            <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-6 text-gray-800">실시간 활동 추적</h3>
            <p className="text-lg sm:text-xl md:text-2xl text-gray-600 mb-8 leading-relaxed">
        ...
        <div className="text-center mb-12 mt-16">
          <h4 className="text-xl sm:text-2xl md:text-3xl font-bold mb-4 px-4 sm:block">시간대별로 나의 집중도를 분석해보세요!</h4>
          <p className="text-base sm:text-lg text-gray-600 px-4 sm:block">언제 가장 집중력이 높은지 파악하여 중요한 작업을 적절한 시간에 배치하세요</p>
        </div>
        ...
        {/* Timeline */}
        <div className="text-center mb-12 mt-16">
          <h4 className="text-xl sm:text-2xl md:text-3xl font-bold mb-4 px-4 sm:block">이제 나의 업무시간, 휴식 습관을 체크해보세요!</h4>
          <p className="text-base sm:text-lg text-gray-600 px-4 sm:block">하루 전체의 업무 패턴을 직관적으로 파악하여 시간 관리를 개선하세요</p>
        </div>
        <div className="grid grid-cols-1 gap-8">
          <div className="group relative overflow-hidden rounded-xl shadow-lg hover:shadow-2xl transition-all duration-500 hover:scale-105">
            <img 
